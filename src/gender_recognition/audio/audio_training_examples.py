...
class AudioSampleGenerator:
    ...
    def generate_window_is_person_map_for_audio(self, audio_path):
...
if __name__ =='__main__':
    window_is_person_map = AudioSampleGenerator().generate_window_is_person_map_for_audio('k_1_1.wav')
